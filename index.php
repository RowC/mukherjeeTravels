...
-->
        ...
        <link rel="stylesheet" href="web-app/css/animate.css">
        <link rel="stylesheet" href="web-app/css/templatemo_misc.css">
        <link rel="stylesheet" href="web-app/css/templatemo_style.css">

        <script src="web-app/js/vendor/modernizr-2.6.1-respond-1.1.0.min.js"></script>
    </head>
    <style>
        #menu-wrapper {
...
<!--                            <li>
                                ...
                                <img src="web-app/images/main-slider-img/sunset1.jpg" alt="" height="600px" width="600px">
                            ...
                            <li>
                                <div class="overlay"></div>
                                <img src="web-app/images/main-slider-img/sunset.jpg" alt="" height="800px" width="600px">
                                <div class="slider-caption visible-md visible-lg">
                                    <h2>Digital Marketing</h2>
                                    <p>more visitors to your website</p>
                                    <a href="#" class="slider-btn">Let us design!</a>
                            ...
                            <li>
                                <div class="overlay"></div>
                                <img src="web-app/images/main-slider-img/morning.jpg" alt="" height="800px">
                                <div class="slider-caption visible-md visible-lg">
                            ...
                            <li>
                                <div class="overlay"></div>
                                <img src="web-app/images/main-slider-img/seab.jpg" alt="" height="800px">
                                <div class="slider-caption visible-md visible-lg">
                            ...
                            <li>
                                <div class="overlay"></div>
                                <img src="web-app/images/main-slider-img/tiger.jpg" alt="" height="800px">
                                <div class="slider-caption visible-md visible-lg">
                                    <h2>Pro Level Design</h2>
                                    <p>High standard work</p>
                                    <a href="#" class="slider-btn">Mobile Website</a>
        ...
        <div class="content-section" id="portfolio">
            <div class="container">
                <div class="row">
                    <div class="heading-section col-md-12 text-center">
                        <h2>Tours guide</h2>
                        <p>Amazing tours plan for our clients</p>
                    </div> <!-- /.heading-section -->
                </div> <!-- /.row -->
                <div class="row">
                    <div class="portfolio-item col-md-3 col-sm-6">
                        <div class="portfolio-thumb">
                            <img src="web-app/images/gallery/sunset1.jpg" alt="" height="260px" width="600px">
                            <div class="portfolio-overlay">
                                <h3>Tour plan one</h3>
                                <p>Asperiores commodi illo fuga perferendis dolore repellendus sapiente ipsum.</p>
                                <a href="web-app/images/gallery/p1.jpg" data-rel="lightbox" class="expand">
                    ...
                    <div class="portfolio-item col-md-3 col-sm-6">
                        <div class="portfolio-thumb">
                            <img src="web-app/images/gallery/p2.jpg" alt="">
                            <div class="portfolio-overlay">
                                <h3>Tour plan two</h3>
                                <p>Asperiores commodi illo fuga perferendis dolore repellendus sapiente ipsum.</p>
                                <a href="web-app/images/gallery/p2.jpg" data-rel="lightbox" class="expand">
                                    <i class="fa fa-search"></i>
                                </a>
                            </div> <!-- /.portfolio-overlay -->
                        </div> <!-- /.portfolio-thumb -->
                    ...
                    <div class="portfolio-item col-md-3 col-sm-6">
                        <div class="portfolio-thumb">
                            <img src="web-app/images/gallery/p7.jpg" alt="">
                            <div class="portfolio-overlay">
                                <h3>tour plan three</h3>
                                <p>Asperiores commodi illo fuga perferendis dolore repellendus sapiente ipsum.</p>
                                <a href="web-app/images/gallery/p7.jpg" data-rel="lightbox" class="expand">
                                    <i class="fa fa-search"></i>
                                </a>
                            </div> <!-- /.portfolio-overlay -->
                        </div> <!-- /.portfolio-thumb -->
                    ...
                    <div class="portfolio-item col-md-3 col-sm-6">
                        <div class="portfolio-thumb">
                            <img src="web-app/images/gallery/p8.jpg" alt="">
                            <div class="portfolio-overlay">
                                <h3>Tour plan four</h3>
                                <p>Asperiores commodi illo fuga perferendis dolore repellendus sapiente ipsum.</p>
                                <a href="web-app/images/gallery/p8.jpg" data-rel="lightbox" class="expand">
                                    <i class="fa fa-search"></i>
                                </a>
                            </div> <!-- /.portfolio-overlay -->
                        </div> <!-- /.portfolio-thumb -->
                    ...
                    <div class="portfolio-item col-md-3 col-sm-6">
                        <div class="portfolio-thumb">
                            <img src="web-app/images/gallery/p3.jpg" alt="">
                            <div class="portfolio-overlay">
                                <h3>Tour plan five</h3>
                                <p>Asperiores commodi illo fuga perferendis dolore repellendus sapiente ipsum.</p>
                                <a href="web-app/images/gallery/p3.jpg" data-rel="lightbox" class="expand">
                                    <i class="fa fa-search"></i>
                                </a>
                            </div> <!-- /.portfolio-overlay -->
                        </div> <!-- /.portfolio-thumb -->
                    ...
                    <div class="portfolio-item col-md-3 col-sm-6">
                        <div class="portfolio-thumb">
                            <img src="web-app/images/gallery/p4.jpg" alt="">
                            <div class="portfolio-overlay">
                                <h3>Tour plan six</h3>
                                <p>Asperiores commodi illo fuga perferendis dolore repellendus sapiente ipsum.</p>
                                <a href="web-app/images/gallery/p4.jpg" data-rel="lightbox" class="expand">
                                    <i class="fa fa-search"></i>
                                </a>
                            </div> <!-- /.portfolio-overlay -->
                        </div> <!-- /.portfolio-thumb -->
                    ...
                    <div class="portfolio-item col-md-3 col-sm-6">
                        <div class="portfolio-thumb">
                            <img src="web-app/images/gallery/p5.jpg" alt="">
                            <div class="portfolio-overlay">
                                <h3>Tour plan seven</h3>
                                <p>Asperiores commodi illo fuga perferendis dolore repellendus sapiente ipsum.</p>
                                <a href="web-app/images/gallery/p5.jpg" data-rel="lightbox" class="expand">
                                    <i class="fa fa-search"></i>
                                </a>
                            </div> <!-- /.portfolio-overlay -->
                        </div> <!-- /.portfolio-thumb -->
                    ...
                    <div class="portfolio-item col-md-3 col-sm-6">
                        <div class="portfolio-thumb">
                            <img src="web-app/images/gallery/p6.jpg" alt="">
                            <div class="portfolio-overlay">
                                <h3>Tour plan eight</h3>
                                <p>Asperiores commodi illo fuga perferendis dolore repellendus sapiente ipsum.</p>
                                <a href="web-app/images/gallery/p6.jpg" data-rel="lightbox" class="expand">
                                    <i class="fa fa-search"></i>
                                </a>
                            </div> <!-- /.portfolio-overlay -->
                        </div> <!-- /.portfolio-thumb -->
                ...
                <div class="row">
                    <div class="team-member col-md-3 col-sm-6">
                        <div class="member-thumb">
                            <img src="web-app/images/member1.jpg" alt="">
                    ...
                    <div class="team-member col-md-3 col-sm-6">
                        <div class="member-thumb">
                            <img src="web-app/images/member2.jpg" alt="">
                            <div class="team-overlay">
                                <h3>Cindy</h3>
                                <span>Developer</span>
                                <ul class="social">
                    ...
                    <div class="team-member col-md-3 col-sm-6">
                        <div class="member-thumb">
                            <img src="web-app/images/member3.jpg" alt="">
                            <div class="team-overlay">
                                <h3>Mary</h3>
                                <span>Director</span>
                                <ul class="social">
                    ...
                    <div class="team-member col-md-3 col-sm-6">
                        <div class="member-thumb">
                            <img src="web-app/images/member4.jpg" alt="">
                            <div class="team-overlay">
                                <h3>Linda</h3>
        ...
        <script src="web-app/js/vendor/jquery-1.11.0.min.js"></script>
        <script>window.jQuery || document.write('<script src="web-app/js/vendor/jquery-1.11.0.min.js"><\/script>')</script>
        <script src="web-app/js/bootstrap.js"></script>
        <script src="web-app/js/plugins.js"></script>
        <script src="web-app/js/main.js"></script>

        <!-- Google Map -->
<!--        <script src="http://maps.google.com/maps/api/js?sensor=true"></script>
        <script src="web-app/js/vendor/jquery.gmap3.min.js"></script>-->
        <!--
         Google Map Init
-->        
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAhbIqHBd4HQoQxqrgdgrx-pWS3inRlhPU&callback=myMap"></script>
